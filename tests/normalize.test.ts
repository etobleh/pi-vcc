...
describe("normalize", () => {
  ...
  it("normalizes assistant thinking blocks", () => {
    const blocks = normalize([assistantWithThinking("result", "hmm reasoning")]);
    expect(blocks).toEqual([
      { kind: "thinking", text: "hmm reasoning", redacted: false, sourceIndex: 0 },
